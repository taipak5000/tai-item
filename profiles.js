  ...
  function pushItems(schedule, name, colorKey) {
    pfDashOccurrencesInRange(schedule, rangeStart, rangeEnd).forEach(o => {
      ...
      items.push({
        ...
        // o.startが無い場合（season）は「開始日が分かっている」こと自体が無いため
